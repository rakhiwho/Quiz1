...
const geogra = document.querySelector(".geo"); 
...
function page(){
  ...
  geogra.style.display="none";
  check.style.display = "block";
  geo.forEach((question , index) => {
  ...
  geogra.addEventListener('click' , page)
 ...
 function results(){
  if(result<5){
    ...
    <h4>let's see how smart you are!</h4>
     <h3>you scored ${result} out of ${geo.length}</h3>
